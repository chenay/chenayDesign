package com.chenay.platform.design.radio;
...
public class GridRadioGroup extends LinearLayout {
    ...
    private static final String LOG_TAG = GridRadioGroup.class.getName();
    ...
    private GridRadioGroup.OnCheckedChangeListener mOnCheckedChangeListener;
    ...
    public void addView(View child, int index, ViewGroup.LayoutParams params) {
        if (child instanceof RadioButton) {
            ...
            for (int i = 0; i < num; i++) {
                //这里要循环
                List<RadioButton> buttons = findRadioButton((ViewGroup) (((ViewGroup) child).getChildAt(i)));
    ...
    public List<RadioButton> findRadioButton(ViewGroup group) {
        ...
        for (int i = 0; i < len; i++) {
            final View childAt = group.getChildAt(i);
            if (childAt instanceof RadioButton) {
                resBtn = (RadioButton) childAt;
                radioButtons.add(resBtn);
            } else if (childAt instanceof ViewGroup &&!(childAt instanceof RadioGroup)) {
                    List<RadioButton> tempButtons = findRadioButton((ViewGroup) childAt);
                    radioButtons.addAll(tempButtons);
            }
        }
        return radioButtons;
    }
     ...
     * </p>
     */
    //{@link android.R.styleable#LinearLayout_Layout LinearLayout
    //* Attributes}
    ...
    private class PassThroughHierarchyChangeListener implements
        ...
        public void onChildViewAdded(View parent, View child) {
            ...
            } else if (parent == GridRadioGroup.this
                    && child instanceof ViewGroup) {
                int num = ((ViewGroup) child).getChildCount();
                for (int i = 0; i < num; i++) {
                    List<RadioButton> btns = findRadioButton((ViewGroup) (((ViewGroup) child).getChildAt(i)));
        ...
        public void onChildViewRemoved(View parent, View child) {
            if (parent == GridRadioGroup.this && child instanceof RadioButton) {
                ...
                int num = ((ViewGroup) child).getChildCount();
                for (int i = 0; i < num; i++) {
                    final List<RadioButton> radioButtons = findRadioButton((ViewGroup) (((ViewGroup) child).getChildAt(i)));
